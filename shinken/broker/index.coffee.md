...
and a type if different from the name.
    ...
    module.exports =
      ...
      configure:
        'ryba-ambari-takeover/shinken/broker/configure'
      commands:
        'check':
          'ryba-ambari-takeover/shinken/broker/check'
        'install': [
          'ryba-ambari-takeover/shinken/broker/install'
          'ryba-ambari-takeover/shinken/broker/start'
          'ryba-ambari-takeover/shinken/broker/check'
        ]
        'prepare':
          'ryba-ambari-takeover/shinken/broker/prepare'
        'start':
          'ryba-ambari-takeover/shinken/broker/start'
        'stop':
          'ryba-ambari-takeover/shinken/broker/stop'
