...
###  Declare services
          ...
          if ('ryba/zookeeper/server' is srv.module) or ('ryba-ambari-takeover/zookeeper/server' is srv.module) 
          ...
          if ('ryba/hadoop/hdfs_nn' is srv.module) or ('ryba-ambari-takeover/hadoop/hdfs_nn' is srv.module) 
          ...
          # HDFS JN
          if ('ryba/hadoop/hdfs_jn' is srv.module) or ('ryba-ambari-takeover/hadoop/hdfs_jn' is srv.module) 
          ...
          if ('ryba/hadoop/hdfs_dn' is srv.module) or ('ryba-ambari-takeover/hadoop/hdfs_dn' is srv.module) 
          ...
          if ('ryba/hadoop/zkfc' is srv.module) or ('ryba-ambari-takeover/hadoop/zkfc' is srv.module) 
          ...
          if ('ryba/hadoop/yarn_rm' is srv.module) or ('ryba-ambari-takeover/hadoop/yarn_rm' is srv.module) 
          ...
          if ('ryba/hadoop/yarn_nm' is srv.module) or ('ryba-ambari-takeover/hadoop/yarn_nm' is srv.module) 
          ...
          if ('ryba/hadoop/mapred_jhs' is srv.module) or ('ryba-ambari-takeover/hadoop/mapred_jhs' is srv.module) 
          ...
          if ('ryba/hadoop/yarn_ts' is srv.module) or ('ryba-ambari-takeover/hadoop/yarn_ts' is srv.module) 
          ...
          if ('ryba/hbase/master' is srv.module) or ('ryba-ambari-takeover/hbase/master' is srv.module) 
            ...
            if options.replication_monitoring?.source_realm is clustername
              is_hbase_rest = config.clusters[clustername]?.services['ryba/hbase/rest'] and config.clusters[options.replication_monitoring?.destination_realm]?.services['ryba/hbase/rest']
              is_hbase_rest_takeover = config.clusters[clustername]?.services['ryba-ambari-takeover/hbase/rest'] and config.clusters[options.replication_monitoring?.destination_realm]?.services['ryba-ambari-takeover/hbase/rest']
              throw Error 'Missing replication_monitoring destination realm' unless options.replication_monitoring?.destination_realm
              throw Error 'HBase REST is required to monitor replication' unless is_hbase_rest or is_hbase_rest_takeover
              source_hbase_rest_hosts = config.clusters[clustername]?.services[if is_hbase_rest then 'ryba/hbase/rest' else 'ryba-ambari-takeover/hbase/rest']
              source_hbase_rest_port = source_hbase_rest_hosts.instances[0].options.hbase_site['hbase.rest.port']
              destination_hbase_rest_hosts = config.clusters[options.replication_monitoring?.destination_realm]?.services[if is_hbase_rest then 'ryba/hbase/rest' else 'ryba-ambari-takeover/hbase/rest'].instances.map (instance) -> instance.node.fqdn
              destination_hbase_rest_port = config.clusters[options.replication_monitoring?.destination_realm]?.services[if is_hbase_rest then 'ryba/hbase/rest' else 'ryba-ambari-takeover/hbase/rest'].instances[0].options.hbase_site['hbase.rest.port']
          ...
          if ('ryba/hbase/regionserver' is srv.module) or ('ryba-ambari-takeover/hbase/regionserver' is srv.module)
          ...
          if ('ryba/hbase/rest' is srv.module) or ('ryba-ambari-takeover/hbase/rest' is srv.module)
          ...
          if ('ryba/hbase/thrift' is srv.module) or ('ryba-ambari-takeover/hbase/thrift' is srv.module)
          ...
          if ('ryba/hive/hcatalog' is srv.module) or ('ryba-ambari-takeover/hive/hcatalog' is srv.module)
          ...
          if ('ryba/hive/server2' is srv.module) or ('ryba-ambari-takeover/hive/server2' is srv.module)
          ...
          if ('ryba/hive/webhcat' is srv.module) or ('ryba-ambari-takeover/hive/webhcat' is srv.module)
          ...
          if ('ryba/oozie/server' is srv.module) or ('ryba-ambari-takeover/oozie/server' is srv.module)
          ...
          if ('ryba/kafka/broker' is srv.module) or ('ryba-ambari-takeover/kafka/broker' is srv.module)
          ...
          if ('ryba/ranger/admin' is srv.module) or ('ryba-ambari-takeover/ranger/hdpadmin' is srv.module)
            ...
            if srv.instances[0].options.site['ranger.service.https.attrib.ssl.enabled'] is 'true'
              ...
              create_service
                ...
                process_name: 'ranger-admin'
                check_command: check_command
          if ('ryba/opentsdb' is srv.module and (srv.instances.length > 1)) or ('ryba-ambari-takeover/opentsdb' is srv.module and (srv.instances.length > 1))
          ...
          if ('ryba/phoenix/queryserver' is srv.module and (srv.instances.length > 1)) or ('ryba-ambari-takeover/phoenix/queryserver' is srv.module and (srv.instances.length > 1))
          ...
          if ('ryba/spark/history_server' is srv.module) or ('ryba-ambari-takeover/spark/history_server' is srv.module)
