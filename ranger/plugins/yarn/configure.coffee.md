...
## Environment
      ...
      for srv in service.deps.yarn
        srv.options.configurations['yarn-site']['yarn.authorization-provider'] = 'org.apache.ranger.authorization.yarn.authorizer.RangerYarnAuthorizer'
      options.hadoop_conf_dir ?= service.deps.yarn[0].options.conf_dir
...
## Ambari Config - YARN Plugin Security
        ...
        options.configurations['ranger-yarn-security']['ranger.plugin.yarn.policy.rest.ssl.config.file'] ?= "#{options.hadoop_conf_dir}/ranger-policymgr-ssl.xml"
...
started, as Ambari required to configuration dictionnaries to exist `ranger-hive-plugin-properties` 
        ...
        for srv in service.deps.yarn
          ...
          srv.options.configurations['ranger-yarn-security'] ?= merge {}, srv.options.configurations['ranger-yarn-security'], options.configurations['ranger-yarn-security']
          srv.options.configurations['ranger-yarn-plugin-properties'] ?= merge {}, srv.options.configurations['ranger-yarn-plugin-properties'], options.configurations['ranger-yarn-plugin-properties']
          srv.options.configurations['ranger-yarn-policymgr-ssl'] ?= merge {}, srv.options.configurations['ranger-yarn-policymgr-ssl'], options.configurations['ranger-yarn-policymgr-ssl']
          srv.options.configurations['ranger-yarn-audit'] ?= merge {}, srv.options.configurations['ranger-yarn-audit'], options.configurations['ranger-yarn-audit']
