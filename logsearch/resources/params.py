...
if 'infra-solr-env' in config['configurations']:
  ...
  infra_solr_ssl_enabled = default('configurations/infra-solr-env/infra_solr_ssl_enabled', 'No')
...
if logsearch_use_external_solr:
  ...
  logsearch_solr_ssl_enabled = True if infra_solr_ssl_enabled == 'Yes' else False
