...
## Enable JMX SSL
        ...
        if !!options.ssl
          ...
          options.jmx_ssl_config['javax.net.ssl.keyStore'] ?= "#{service.deps.hdfs_jn.options.ssl_server['ssl.server.keystore.location']}"
          throw Error 'Missing Journalnode Keystore Password' unless service.deps.hdfs_jn.options.ssl_server['ssl.server.keystore.password']
          options.jmx_ssl_config['javax.net.ssl.keyStorePassword'] ?= service.deps.hdfs_jn.options.ssl_server['ssl.server.keystore.password']
          #jmx_exporter client truststore
          options.opts.java_properties['javax.net.ssl.trustStore'] ?= "#{service.deps.hdfs_jn.options.ssl_client['ssl.client.truststore.location']}"
          throw Error 'Missing JournalNode Truststore Password' unless service.deps.hdfs_jn.options.ssl_client['ssl.client.truststore.password']
          options.opts.java_properties['javax.net.ssl.trustStorePassword'] ?=  service.deps.hdfs_jn.options.ssl_client['ssl.client.truststore.password']
        else
